...
/*
 Todo:Asenkron fonksiyonların return tipinde doğrudan fonksiyonun return ettiği verinin tipini yazdığımız zaman hata alırız.Asenkron fonksiyonların return tipi her zaman Promise interface'i aracılığı ile tanımlanır .Promise interface'i asenkron işlemler yapan fonksiyonun return tipini ifade eder
 */
